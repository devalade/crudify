...
class LivewireComponentGenerator extends BaseGenerator
{
    public function generate(string $model): array
    {
        ...
        $paths = array_merge($paths ?? [], $this->generateIndex($model, $modelBase, $modelVar, $models, $kebabModels, $viewPath, $pluralBase));
        $paths = array_merge($paths, $this->generateCreate($model, $modelBase, $modelVar, $models, $kebabModels, $viewPath, $pluralBase));
        $paths = array_merge($paths, $this->generateEdit($model, $modelBase, $modelVar, $models, $kebabModels, $viewPath, $pluralBase));
        $paths = array_merge($paths, $this->generateShow($model, $modelBase, $modelVar, $models, $kebabModels, $viewPath, $pluralBase));

        return $paths;
    }

    protected function generateIndex($model, $modelBase, $modelVar, $models, $kebabModels, $viewPath, $pluralBase)
    {
    ...
    protected function generateCreate($model, $modelBase, $modelVar, $models, $kebabModels, $viewPath, $pluralBase)
    {
        $namespace = 'App\\Livewire\\Pages\\' . $pluralBase;
        $class = 'Create';
    ...
    protected function generateEdit($model, $modelBase, $modelVar, $models, $kebabModels, $viewPath, $pluralBase)
    {
        $namespace = 'App\\Livewire\\Pages\\' . $pluralBase;
        $class = 'Edit';
    ...
    protected function generateShow($model, $modelBase, $modelVar, $models, $kebabModels, $viewPath, $pluralBase)
    {
        $namespace = 'App\\Livewire\\Pages\\' . $pluralBase;
        $class = 'Show';
